<section id="structure" class="structure">
	<div class="content container">
		...
		<p>
			...
			número de utensílios diversos, para preparar os mais variados tipos de comida e servir os
			hóspedes. O Espaço Gourmet possui amplo espaço para confraternizações, churrasqueira, forno e
			fogão a lenha, freezer, bar rústico, vários conjuntos de mesas bistrô inclusas e caso haja um
			grande número de pessoas no evento temos cadeiras e mesas para serem alugadas à parte. A ampla
